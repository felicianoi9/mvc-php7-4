...
<div class="main_content_box">
    <div class="login">
        <form class="form" action="<?= $router->route("painel.auth.login"); ?>" method="post" autocomplete="off">
            ...
            <div class="form_actions">
                ...
                <a href="<?= $router->route("painel.forget"); ?>" title="Recuperar Senha">Recuperar Senha</a>
            </div>
        </form>

        <div class="form_register_action">
            <p>Ainda não tem conta?</p>
            <a href="<?= $router->route("painel.register"); ?>" class="btn btn-blue">Cadastre-se Aqui</a>
        </div>
    </div>
</div>
