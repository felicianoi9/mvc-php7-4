...
<div class="main_content_box">
    <div class="login">
        <form class="form" name="reset" action="<?= $router->route("painel.auth.reset"); ?>" method="post" autocomplete="off">
        ...
        <div class="form_register_action">
            ...
            <a href="<?= $router->route("painel.login"); ?>" class="btn btn-blue">Voltar ao Login</a>
        </div>
    </div>
</div>
