...
<div class="main_content_box">
    <div class="login">
        <form class="form" action="<?= $router->route("painel.auth.register"); ?>" method="post" autocomplete="off">
        ...
        <div class="form_register_action">
            <p>Já tem conta?</p>
            <a href="<?= $router->route("painel.login"); ?>" class="btn btn-blue">Fazer Login</a>
        </div>
    </div>
</div>
